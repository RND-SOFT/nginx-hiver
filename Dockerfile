...
LABEL maintainer="Serg Fedosov sergey@rnds.pro"
...
# Install Forego https://github.com/jwilder/forego/releases/download/v0.16.1/forego
...
ENV PATH /opt/hiver/node_modules/.bin:$PATH
